      ...
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            ...
            <Picker.Item label="product5" value="product5" />
            <Picker.Item label="product6" value="product6" />
            <Picker.Item label="product7" value="product7" />
            <Picker.Item label="product8" value="product8" />
          </Picker>
        </View>
        </View>
        <View style={styles.InputContainer}>
